      ...
      <div className='<div class="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">'>
        ...
        <div className='md:w-1/2 px-8 md:px-16'>
          ...
          <form action='' class='flex flex-col gap-4'>
            ...
            <button className='py-2 rounded-xl text-white bg-[#002D74] hover:scale-105 duration-500'></button>
          </form>
          {/*  */}
          ...
          {/*  */}
          <button className='flex justify-center w-full items-center bg-white rounded-xl text-[#002D74] text-sm mt-5 py-2 hover:scale-105 duration-500'></button>
        </div>
      </div>
    </section>
  );
